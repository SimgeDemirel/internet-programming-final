...
<form action="panelgiris.php" method="post" style="max-width:500px;margin:auto">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" placeholder="Adınız Soyadınız" name="usrnm">
  </div>

  <div class="input-container">
    <i class="fa fa-envelope icon"></i>
    <input class="input-field" type="text" placeholder="E-mailiniz" name="email">
  </div>
...
{
  if($_POST["usrnm"]=="admin" && $_POST["psw"]="12345" && $_POST["email"]="sigortanbizden@gmail.com")
  {
